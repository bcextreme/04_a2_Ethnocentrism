...
class ModelGUI(tk.Tk):
    ...
    def __init__(self, model):
        ...
        self.canvas = tk.Canvas(self.canvas_frame, width=self.canvas_size,
                                height=self.canvas_size, highlightbackground="black",
    ...
    # Continues running the model simulation until stopped.
    def run_model(self):
        while self.running:
            self.step()
            self.update()
